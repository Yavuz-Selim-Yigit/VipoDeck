...
LIGHT = {
    "bg": "#0e1726",          # üst/arka koyu lacivert (modern)
    "fg": "#e2e8f0",
    "muted": "#94a3b8",
    "card_bg": "#111827",
    "card_border": "#334155",
...
DARK  = LIGHT  # aynı palet (uyum için tek koyu palet)
# İstersen açık tema eklemek için LIGHT'ı açık renklere çevirebilirsin.
...
class ShortcutEditor(QtWidgets.QDialog):
    ...
    def _toggle_fields(self):
        ...
        # küçük tema uyumu
        pal = self.palette()
        pal.setColor(QtGui.QPalette.Base, QtGui.QColor("#111827"))
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.theme = self.settings.value("theme", "dark")  # default koyu
    ...
    def _build_central(self):
        ...
        v.addStretch(1)  # sol altta min/close YOK (kaldırıldı)
    ...
    def _apply_theme(self):
        ...
        self.sidebar.setStyleSheet(
            "QFrame { background: rgba(255,255,255,0.03); border-right:1px solid rgba(255,255,255,0.10); }"
        )

        # pencere ve form kontrolleri (tema uyumlu)
        ...
        main_css = f"""
        QMainWindow {{ background:{self.palette['bg']}; }}
        QLineEdit {{
            background: {base_bg};
            color: {base_fg};
        ...
        QScrollBar::handle:vertical {{
            background: {border_col}; min-height: 24px; border-radius: 4px;
        }}
    ...
    def _toggle_theme(self, checked: bool):
        self.theme = "dark" if checked else "dark"   # tek koyu tema; istersen açık tema ekleyebilirsin
